...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Employee e1 = new Employee(1, "Кирилл", "Афанасьев", 30, 5000);
        Employee e2 = new Employee(2, "Петр", "Петров", 28, 2000);
        Employee e3 = new Employee(3, "Серафим", "Иванович", 35, 3000);
        Employee e4 = new Employee(4, "Анна", "Иванова", 26, 5100);
        Employee e5 = new Employee(5, "Карина", "Миронова", 32, 2700);
        Employee e6 = new Employee(6, "Сергей", "Шарко", 45, 3750);
        Employee e7 = new Employee(7, "Ольга", "Смирнова", 40, 5400);
        Employee e8 = new Employee(8, "Дмитрий", "Дюшев", 29, 3500);
